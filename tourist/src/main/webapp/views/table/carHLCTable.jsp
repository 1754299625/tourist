...
<p style="text-align: center;font-size: 18px;font-weight: 700;margin-bottom: 10px;">${enter_day} ${scenic_name} 实时车流量分析</p>
    ...
    layui.use(['jquery', 'layer', 'element'], function (args) {
        ...
        myChart.showLoading();	//数据加载完之前先显示一段简单的loading动画
            $.ajax({	//使用JQuery内置的Ajax方法
                ...
                url: "${pageContext.request.contextPath}/Data/getCarHLCInfor.do",	//请求发送到ShowInfoIndexServlet处
