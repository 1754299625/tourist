    ...
    <blockquote class="layui-elem-quote">
        <div class="layui-form-pane">
            <div class="layui-form-item">
                ...
                <div class="layui-form-item" style="position:relative;display: inline-block;line-height: 2.7;">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="javascript:;" id="test2" data-name="{{ item.id }}" data-title="{{ item.scenicname }}"
               data-id="{{item.enter_day}}" data-opt="edit"
               class="layui-btn layui-btn-normal " onclick="TestHLC(this)" style="z-index: 10;">客流承载量</a>
