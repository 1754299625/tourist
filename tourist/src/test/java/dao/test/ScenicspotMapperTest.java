...
public class ScenicspotMapperTest {
    ...
    @Test
    public void testscenicspotMapper() {

        try {
            PageHelper.startPage(3, 1);//页数 每页的数量
            List<Scenicspot> list = scenicspotMapper.getScenicspotAll(scenicspot);
    ...
    public void getScenicBycode() {
        try {
            scenicspot = scenicspotMapper.getScenicspotByCode("1");
    ...
    public void updateScenicBycode() {
        try {
            ...
            try {
                System.out.println(scenicspotMapper.getScenicspotByCode("1"));
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void deleteScenicBycode() {
        try {
            scenicspotMapper.deleteByCode("1");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
